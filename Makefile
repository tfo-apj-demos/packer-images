ubuntu_2204_base:
	packer init -var-file builds/linux/ubuntu/2204/base.pkrvars.hcl builds/linux/ubuntu/2204
	packer build -var-file builds/linux/ubuntu/2204/base.pkrvars.hcl builds/linux/ubuntu/2204
