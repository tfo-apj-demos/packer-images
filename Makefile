...
ubuntu_2204_postgres:
	packer init -var-file builds/linux/ubuntu/2204/postgres.pkrvars.hcl builds/linux/ubuntu/2204
	packer build -var-file builds/linux/ubuntu/2204/postgres.pkrvars.hcl builds/linux/ubuntu/2204